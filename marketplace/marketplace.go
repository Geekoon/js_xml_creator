...
func init() {
	filelog, err := os.OpenFile("marketplace.log", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0666)
	if err != nil {
		log.Fatal("Couldn't open log file 'marketplace.log'!", err)
	}
...
// Замена реального количества товаров на абстрактное
...
// Обработка SQL запроса, возвращающего пару число-строка
...
// Обработка SQL запроса, возвращающего пару строка-строка
...
func main() {
	...
	xmlFileName := "yandex_marketplace.yml"
